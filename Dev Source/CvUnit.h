...
public:
	...
	bool canDoCommand(CommandTypes eCommand, int iData1, int iData2, bool bTestVisible = false, bool bTestBusy = true, CvPlot* pPlot = NULL);	// Exposed to Python
...
//FfH Spell System: Added by Kael 07/23/2007
	bool canCast(int spell, bool bTestVisible, CvPlot* targetPlot = NULL);
	...
	void castDamageSecondaryPlot(int spell, CvPlot* pTargetPlot, bool secondaryPlot);
...
//<<<<Refined Defensive Strikes: End Modify
	...
	int getCityResistance() const;
	int getUnitSpellResistance() const;
...
/*************************************************************************************************/
	...
	int getSpellCritChance(CvSpellInfo &spell) const;
	int getSpellTargetNumber(CvSpellInfo &kSpell) const;

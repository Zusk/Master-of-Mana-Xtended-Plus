...
/*************************************************************************************************/
	...
	int getAITurnHappinessBonus() const;																// Exposed to Python
...
// BUG - Building Additional Commerce - start
	...
	int getAdditionalBaseCommerceRateByBuildingTimes100Impl(CommerceTypes eIndex, BuildingTypes eBuilding) const;
...
/*************************************************************************************************/
	...
	int getFeatureYieldIncome(int iI) const;
	int getFeatureYieldIncomeChange(int iYield) const;
	void updateFeatureYieldIncome(int iYield);

...
public:
	...
	DllExport void setUnitHelp(CvWStringBuffer &szString, CvUnit* pUnit, bool bOneLine = false, bool bShort = false);
	...
	DllExport bool setDefensiveCombatOddsHelp(CvWStringBuffer& szString, CvUnit* pAttacker, CvUnit* pDefender);
	DllExport bool setSpellFactorsPlotHelp(CvWStringBuffer& szString, CvPlot* pPlot);
...
private:
	...
	void getDiscoverChanceText(CvPlot* pPlot, CvWStringBuffer& szString, CvWString szTempBuffer);

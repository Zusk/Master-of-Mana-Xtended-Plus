...
void CyTeamPythonInterface()
{
	...
	python::class_<CyTeam>("CyTeam")
		...
		.def("declareWarLog", &CyTeam::declareWarLog, "void (int /*TeamTypes*/ eTeam, bool bNewDiplo, int /*WarPlanTypes*/ eWarPlan, TCHAR szLog = NULL) - Forces your team to declare War on iTeam")
		...
		.def("getAnyWarPlanCount", &CyTeam::getAnyWarPlanCount, "int (bool bIgnoreMinors,int /*TeamTypes*/ eTeam)")

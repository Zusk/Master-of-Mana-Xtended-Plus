...
public:
	...
	int getReligionCommerceTechRateModifier(int religionType, int eIndex) const;
...
/*************************************************************************************************/
	...
	int** m_ppiReligionCommerceModifiers;
...
public:
	...
	int getTechDiscover() const;				// Exposed to Python
	int getAITradeModifier() const;			// Exposed to Python

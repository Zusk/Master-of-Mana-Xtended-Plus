...
public:
	ClimateGroup() : terrain(NO_TERRAIN), IsMajorArea(false)
	{

	}
	
	std::set<CvPlot*> plots;
...
public:
	...
	void addMana();
	void changeTerrainBasedOnPlayers();
	void addTerrainSpecials();
	std::vector<StartRequirements> getPlayersAndStartsWanted();
	StartRequirements getWantedStartForPlayer(int player);
	bool useClimateBasedStartPos();

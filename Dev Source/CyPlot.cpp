...
int CyPlot::calculateImprovementUpgradeRate(int /*ImprovementTypes*/ eImprovement, int /*PlayerTypes*/ ePlayer)
{
	return m_pPlot ? m_pPlot->calculateImprovementUpgradeRate((ImprovementTypes)eImprovement, (PlayerTypes)ePlayer) : -1;
}

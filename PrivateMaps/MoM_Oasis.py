...
class MoM_Oasis:
	...
	def normalizeStartingPlotLocations(self):
		return None

	def normalizeAddRiver(self):
		return None
...
def normalizeStartingPlotLocations():
	return mapscript.normalizeStartingPlotLocations()

def normalizeAddRiver():
	return mapscript.normalizeAddRiver()

def normalizeRemoveBadTerrain():
	return mapscript.normalizeRemoveBadTerrain()

def normalizeAddGoodTerrain():
	return mapscript.normalizeAddGoodTerrain()

def normalizeAddExtras():
	return mapscript.normalizeAddExtras()

...
class MapConstants :
	def initialize(self):
		...
		self.WaterRegionsPerPlot = 0.00002 #Water regions per map plot
...
def addFeatures():
    ...
    for y in range(mapSize.MapHeight):
        for x in range(mapSize.MapWidth):
            ...
            if (featureHaunted != -1 and plotMap.plotMap[i] != plotMap.PEAK and not plot.isWater()):

...
/**	ADDON (New Functions Definition) Sephi                                     					**/
/*************************************************************************************************/
	void changeBonusAptitude(BonusTypes eIndex, int iChange);
	int getBonusAptitude(BonusTypes eIndex) const;
	void changeBonusSummonStrength(int iChange);
	int getBonusSummonStrength() const;
	void updateBonusSummonStrength();
	void updateBonusAptitude(BonusTypes eIndex);
...
//FfH Spell System: Added by Kael 07/23/2007
	...
	int m_iBaseCombatDefenseCarryOver;
...
/*************************************************************************************************/
	...
	int* m_paiBonusAptitude;
	int* m_paiBonusAptitudeAmount;

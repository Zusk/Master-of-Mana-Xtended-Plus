...
#							screen.setTableText(szTable, 5, iRow, gc.getTeam(iBestBuildingTeam).getBuildingClassCount(i), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
	...
	#							screen.setTableText(szTable, 5, iRow, gc.getTeam(iBestBuildingTeam).getBuildingClassCount(i), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
				...
				#miracle victory Xtended
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_ORDER")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_THE_ORDER'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Oath of Dominion Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_EMPYREAN")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_THE_EMPYREAN'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Light of Redemption Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_ROK")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_RUNES_OF_KILMORPH'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Hymn to the Earthmother Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_FOL")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_FELLOWSHIP_OF_LEAVES'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Rite of the Wilds Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_OO")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_OCTOPUS_OVERLORDS'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Chants of Madness Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true
				if (iLoopVC==gc.getInfoTypeForString("VICTORY_RELIGION_AV")):
					pPlayer=gc.getPlayer(self.iActivePlayer)
					if pPlayer.getStateReligion() == gc.getInfoTypeForString('RELIGION_THE_ASHEN_VEIL'):
						iRow = screen.appendTableRow(szTable)				
						screen.setTableText(szTable, 0, iRow, "Complete Litany of Endings Miracle", "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
						bEntriesFound = true

...
def ScionUnitCreated(argsList):
	...
	if iUnitType==gc.getInfoTypeForString('UNIT_ARCHER'):
		...
		lPromoList = ['PROMOTION_SNOW_GEAR_RECON', 'PROMOTION_NIGHT_GEAR_RECON', 'PROMOTION_WOODS_GEAR_RECON', 'PROMOTION_DESERT_GEAR_RECON', 'PROMOTION_GEAR_HEAD_HUNTING_CONTRACT', 'PROMOTION_CLIMBING_KIT_RECON', 'PROMOTION_CALTROPS_RECON']
